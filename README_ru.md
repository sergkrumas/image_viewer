...
**(10 авг 26) Начиная с 2024 года я постоянно переношу релиз на лето следующего года, однако даже в это лето не успеваю подступиться к нему, потому что летом надо отдыхать, а не релизить такие большие софты. Поэтому на сей раз оставляю дату релиза неопределённой, т.к. мне надо доделать рефакторинг и добавить функционал, который я не успел добавить в первой трети этого года, хотя за это время было сделано около 1 500 коммитов. Больше инфы и коммитов ожидается осенью 2026 года.**
