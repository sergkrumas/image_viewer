...
Приложение построено на основе разных страниц-миниприложений. Каждая из них предоставит вам отличный от других опыт любования картинками.

Поменять текущую страницу можно в меню левого верхнего угла или нажимая клавишу `TAB`.

В настройках приложения любую страницу можно задать страницей по-умолчанию, которая будет открываться для обработки пользовательских запросов из проводника Windows.
...
### [Ультракороткая презентация Viewer на Youtube](https://www.youtube.com/watch?v=hlu9MMdf4-A)

### [Ультракороткая презентация Board на Youtube](https://www.youtube.com/watch?v=cWVgUz3I5Po)

### [Листание кадров анимированных изображений перемещением курсора мыши](https://www.youtube.com/watch?v=SJfZS_eH4aI)
...
- клавиша `F4` - активирует режим перемотки курсором, который можно встретить в видеоредакторах, а воспроизведение будет остановлено пока снова не будет нажата клавиша `F4`
...
При наведении курсора мыши на превьюшку в правой части, в левой части отобразится её оригиинал с максимальном масштабе. Анимированные файлы не проигрываются, но можно смотреть отдельный кадр анимации, выбирая этот кадр горизонтально перемещая курсор мыши по превьюшке анимированного файла:
...
В целях навигации по доске можно пользоваться геймпадом Playstation 4 DualShock или его дешёвым аналогом - ShanWan PC/PS3/Android. 


![](docs/supported_gamepads_march_2025.png)

**Управление с геймпада активируется через контекстное меню. В настройках приложения есть отдельная секция для геймпада.** Также читайте справку через клавишу `F1`.

Если геймпада в семье нет (или у вас какой-нибудь геймпад от Xbox, которые не поддерживаются в данный момент), то облегчить его отсутствие можно через встроенную автопрокрутку, который активируется и дезактивируется через нажатие на колесо мыши. Автопрокрутка работает так же, как он работает в большинстве веб-браузеров. Ну и чтобы окончательно было хорошо, в режиме автопрокрутки масштабирование становится плавней, добавляется затухание.
...
На скриншоте ниже всё расписано, повторяться тут не буду (Рапуся на фоне, сгенерированная с помощью ИИ, это обои рабочего стола, а не фича плагина):
...
Чтобы изменить радиус скругления углов превьюшек, зажимите `Alt` и крутите колесо мыши.
...
**(10 авг 26) Начиная с 2024 года я постоянно переношу релиз на лето следующего года, однако даже в это лето не успеваю подступиться к релизу, потому что летом надо отдыхать, а не релезить такие большие софты. Поэтому на сей раз оставляю дату релиза неопределённой из-за того, что мне надо доделать рефакторинг и добавить функционал, который я не успел добавить в первой трети этого года, хотя за это время было сделано около 1 500 коммитов. Больше инфы и коммитов ожидается осенью 2026 года.**
...
(28 фев 26) Названия страниц хотелось бы перевести на русский, но я пока не определился с вариантами, да и времени на это нет, поэтому пропишу это здесь
- Viewer Page: видовая/смотровая
- Board Page: интерактивная/пюрешная
- Start Page: начальная/вводная/пусковая
- Waterfall Page: поточная
- Library Page: библиотечная
Как видно из примеров выше, варианты можно предлагать весьма образные. Однако, их надо подбирать так, чтобы первые буквы в названиях страниц не совпадали между собой. Если кто хочет предложить свои идеи, пишите в Issues https://github.com/sergkrumas/image_viewer/issues
...
| янв 2026 | Внедрение Waterfall Page, вертикальной автопрокрутки для списков, подготовка к переводу на иностранные языки | автопрокрутка во все стороны для навигации по доске |
| фев 2026 - май 2026 | масштабный рефакторинг, исправление багов | масштабный рефакторинг, исправление багов |
| фев 2026 - май 2026 | перелистывание кадров анимационных файлов на страницах Waterfall, Library и Viewer с помощью перемещения курсора мыши слева направо и обратно | перелистывание кадров анимационных файлов и групп с помощью перемещения курсора мыши слева направо и обратно |
| фев 2026 - май 2026 | для Waterfall добавлены закругления к превьюшкам, настраиваемые вертикальные и горизонтальные отступы между преьюшками; модальный вьювер открывается сразу, если был запрос показать конкретный файл в папке | введена настройка для раскладывания айтемов на доске вертикально (полезно для сканов книг) |
| фев 2026 - май 2026 | изменён внешний вид окна настроек, UI и UX задания настроек, изменён внешний вид контекстного меню | `Ctrl+Z` для отмены вращения, перемещения и масштабирования айтемов |
| фев 2026 - май 2026 | расширение списка команд, доступных через контекстное меню | `F12` больше не активирует/дезактивирует геймпад, теперь надо залезать в контекстное меню для этого |
| фев 2026 - май 2026 | «Slice Pipette Tool» теперь переименован в «Line EyeDropper Tool» и доступен на всех страницах через контекстное меню | новая настройка - автовключение управления с геймпада при старте приложения |
| фев 2026 - май 2026 | множественные изменения горячих клавиш, они описаны в CHANGELOG.md | новая настройка - управление с геймпада только когда окно в фокусе (на переднем плане и принимает фокус ввода с клавиатуры) |
| фев 2026 - май 2026 | прогрессивная развёртка превьюшек на странице Waterfall и Library, исправлена поддержка APNG по всему приложению | с геймпада теперь можно листать кадры видимых в окне анимационные айтемов, подробности в CHANGELOG.md |
| фев 2026 - май 2026 | введена настройка, которая позволяет задавать начальную страницу при обработке запросов из проводника Windows | ***прогрессивная развёртка айтемов-изображений на доске*** - больше не надо ждать, пока для всех будут сгенерированы превьюшки и айтемы раскладыаются по мере готовности превьюшек по возможности с соблюдением порядка, в котором файлы отображаются в папке проводника Windows |
| фев 2026 - май 2026 |  | внедрена сырая версия для выравнивания группы айтемов и их распределеения на доске |
| фев 2026 - май 2026 |  | теперь при изменении масштаба отображения доски во время вращения и масштабирования айтемов не происходит дичи с перепозиционированием айтемов |
| фев 2026 - май 2026 |  | автопрокрутка добавлена при переносе, вращении и масштабировании айтемов, если курсор подходит ко краям окна |
| фев 2026 - май 2026 |  | теперь на досках могут отображаться превьюшки аудио-видео айтемов |
| фев 2026 - май 2026 |  | реализована функция прилипания - айтемы можно ставить углами и серединами друг к другу без необходимости точно выставлять их, нужно только поднести к нужному месту, а программа заставит айтем прилипнуть к нужному месту |
| фев 2026 - май 2026 |  | основной функционал плагина NET TRACKER внедрён в функциональное ядро BOARDS: теперь есть возможность создавать ноды и линки к нодам, также линки можно создавать вообще к любым айтемам; нода содержит в себе поддоску; UX для создания линков и нодов, для их выделения |
| фев 2026 - май 2026 |  | вкручен режим кроссдоски, которая отображает контент всех досок на одной кроссдоске; на кроссдоске можно переместить айтемы с одной доски на другую доску и задать линки между айтемами, находящимися в разных досках |
| фев 2026 - май 2026 |  | у нод появляются постеры, которые прокручивают превьюшки айтемов, которые содержатся в доске ноды |
| фев 2026 - май 2026 |  | скрываем панели управления во время трансформации айтемов и во время автопрокрутки |
| фев 2026 - май 2026 |  | переработана и улучшена загрузка и сохранение board-файлов, сохраняется больше полезной инфы и не сохраняется мусорная информация некоторых атрибутов; исправлены баги, которые ломали всё, если папка с картинками с доски переносилась в другое место |
| фев 2026 - май 2026 |  | блокировка смещений по одной из осей по время автопрокрутки доски (клавиши `X` и `Y`) |
| фев 2026 - май 2026 |  | теперь из проводника можно вставить или сбросить более одного файла и выбрать расположение ряда этих файлов (вертикальное/горизонтальное) |
| фев 2026 - май 2026 |  | ведётся список недавно открытых board-файлов, доступный через контекстное меню |
| фев 2026 - май 2026 |  | можно делать скриншоты всей доски через команду в контекстном меню; они будут поделены на куски, которые будут сшиты в одном html-файле  |
| фев 2026 - май 2026 |  | можно делать обрезку айтемов или комбинировать их вместе и сохранять как новый айтем, подробности в CHANGELOG.md |
| фев 2026 - май 2026 |  | айтемы внутри досок анимированных айтемов (то есть, кадры анимированных картинок ) теперь можно просматривать на странице Viewer, а следовательно, и сохранять через контекстное меню |
| фев 2026 - май 2026 |  | добавлена функция поиска файлов других папках, доступна через панель управления с кнопкой, на которой написано `Find`; добавлена функция копирования файлов, если они находятся не в той папке, что и доска; |
| фев 2026 - май 2026 |  | доработан код для операций Копировать & Вставить и Вырезать & Вставить после добавления функционала NET TRACKER |  
| фев 2026 - май 2026 |  | доработан код для операции удаления выделенных айтемов |
| фев 2026 - май 2026 |  | боковые кнопки Forward и Backward на мышке теперь можно использовать, чтобы нырять и выныривать из досок |
| фев 2026 - май 2026 |  | произведены наработки по IPC-фичам, которые позволят снизить кол-во микрофризов при работе в приложении |
| ***ВЫ НАХОДИТЕСЬ ЗДЕСЬ***
...
| ???? | | **для айтемов на досках - интерактивный таймлайн истории действий** |
| ???? | | **монтажный стол** |
...
- `-standard` - затребовать запуск в обычном (полном) режиме
- `-frame` - затребовать запуск в окне, а не показывать окно на полный экран
- `-library` - затребовать запуск со страницы библиотеки
