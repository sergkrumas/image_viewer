...
На данный момент документация ещё не готова и только [CHANGELOG.md](CHANGELOG.md) может пролить свет на процесс разработки.

Первый релиз планируется летом 2025 года. Ранее был указан 2024 год, но мне придётся довести до ума страницу Board (которая клонирует основные возможности PureRef), и вдобавок обойти питоновский GIL для устранения микрофризов в UI при загрузке файлов изображений.
...
| Дата | Image Viewer | Boards (PureRef) |
|------|--------------|------------------|
| 11 февраля 2022 | Начало разработки | |
| 28 марта 2022 | Начинаем пользоваться сырой альфа-версией под Windows | |
| 30 мая 2022 | Готова бета-версия | |
| 1 июня 2022 | Начаты бета-тесты и подготовка к релизу | |
...
| 27 мая 2024 - (не завершено) | | Доработка недостающих частей функционального ядра |
| окт 2024 | доведение UX до ума и исправление крашей | |
| 5 ноя 2024 | теперь миниатюры упорядочиваются согласно текущему порядку файлов в открытой папке проводника Windows | |
|  | *ВЫ НАХОДИТЕСЬ ЗДЕСЬ* |  |
| ???? | **синхронизация порядка миниатюрок с порядком файлов в папке Windows** |  |
| ???? | **многопоточная генерация миниатюрок** | **многопоточная генерация превьюшек** |
| ???? | **перевод UI на английский язык (как опция в настройках)** | |
| ???? | **подробная документация и ролик на Youtube** | |
| лето 2025 | **первый релиз** | |
