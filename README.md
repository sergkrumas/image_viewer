...
- Любая область картинки может быть прокомментирована текстовым блоком (не доступно в лайтовом режиме)
...
- Доработать лайтовый режим дополнительными проверками, чтобы не было внезапных крашей
- Сделать переводы интерфейса на Английский, Французский, Немецкий, Итальянский и Испанский
- Для страницы PureRef добавить возможность оставлять пометки с помощью модуля Oxxxy, сохранять их на диск, и при надобности отображать их при повторном открытии
