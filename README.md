# [Russian] [PyQt] GIF/AnimatedWEBP/WEBP/SVG/PNG/JPG/JPEG/JFIF/ICO/BMP/SVG/TGA/TIF/AVIF/HEIF/HEIC Image Viewer v0.9 for Windows by Sergei Krumas
...
- Доработать упрощённый режим дополнительными проверками, чтобы не было внезапных крашей
- Сделать переводы интерфейса на Английский, Французский, Немецкий, Итальянский и Испанский
- Для режима PureRef добавить возможность оставлять пометки с помощью модуля Oxxxy, сохранять их на диск, и при надобности отображать их при повторном открытии
