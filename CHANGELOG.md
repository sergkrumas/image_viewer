...
BOARDS
  ...
  - написана основа плагина Watch Tower, который добавляет на виртуальную доску изображения из списка папок, задаваемого заранее. Каждая папка - отдельный столбец
