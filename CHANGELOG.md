...
- поддержка формата APNG (\*.apng, \*.png)
  ...
  - поддержка на странице вьювера вьювере
  - поддержка в создании миниатюрок для вьювера (заработало без моего вмешательства)
  ...
  - APNG-анимация может быть расположена в файлах с расширением \*.png
