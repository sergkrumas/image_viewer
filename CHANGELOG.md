...
- BOARDS
    ...
    - (23 мар 26) NET TRACKER
        - идея: сетевой планировщик с возможностью прокручивать таймлайн истории действий
        ...
        - добавляет два типа данных: ноды и линки (связи)
            ...
            - линки (связи) между нодами будут поддерживать объекты из параллельного списка board_items_links
                - линки не находятся в айтемах, потому что принятыми в Boards методами трансформации с ними не повзаимодействуешь 
