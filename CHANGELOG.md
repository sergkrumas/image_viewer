...
- BOARDS
  ...
  - (26 мар 25) UX: easing-фильтр для стика перемещения по доске, чтобы камера трогалась легче при малых отклонениях стика
    ...
    - при значении выше 1.0 (максимум 4.0) будет удобней выбирать стиком малые скорости смещения, чтобы ккамера не трогалась резко, когда начинаешь выводить стик из положения покоя
