...
- ОБЩЕЕ
    - (16 фев 26) исправил досадную опечатку, которая стоила произодительности, если бы в папке с картинками были другие тяжёлые некартиночные файлы
        - до правки этой опечатки программа пыталась загрузить некартиночные файлы как картинки, тратя ресурсы на чтение с диска и разбор данных, теперь такой дичи не происходит
