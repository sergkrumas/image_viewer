...
- теперь перед открытием вьювера для конкретной папки или для конкретного изображения программа спросит у пользователя открыть ли окно в лайтовом режиме или в обычном, когда перед непосредственным открытием окна в самом начале много времени уходит на сканирование папок сессии добавленных в библиотеку 
...
- PureRef переименовывается в Boards, потому что с завтрашнего дня я начинаю расширять функционал
...
- виджет трансформации для каждого айтема на странице BOARDS
    - выделение айтемов
...
- BOARDS
    ...
    - добавлен новый тип айтема - группа. То же самое, что и айтем-папка. Только для группировки изображений текущей папки
