...
- Теперь при увеличении с 1% в большую сторону картинка некоторое время будет центироваться на позиции курсора. Это сделано для того, чтобы при увеличении масштаба, она не вылетела резко за края окна из-за ошибок округления в алгоритме мастабирования
