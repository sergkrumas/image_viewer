...
- BOARDS
  ...
  - (29 июн 25) портированный код примера Elastic Nodes из документации Qt превращён в плагин Elastiques Nodes для Boards
    - файл может быть запущен как Board-плагин или как десктопное приложение в зависимости от значения глобальной переменной `USE_PYQT_VERSION`
    - пока переносил код с C++ на PyQt наконец дошло как симулируется эластичность в данном примере
    - данный пример может быть использован для анимации нод-айтемов в плагинах, как это реализовано в Obsidian Graph View
