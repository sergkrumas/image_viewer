...
BOARDS
  ...
  - плагин FRONT TRACKER
      ...
      - в первом файле настроек задаются папки для сканирования и нахождения в них текстовых файлов для парсинга
      - во втором файле настроек задаются исключения для сканирования: или целое имя файла, или начальный суффикс имени файла, который надо исключить из сканирования
