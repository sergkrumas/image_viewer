...
BOARDS
  ...
  - можно менять надпись айтема-фрейма через контекстное меню; для этого контекстное меню надо вызывать над надписью айтема-фрейма или над самим айтемом-фреймов
  ...
  - в тестовом режиме подключён геймпад logitech для управления положением и масштабом вьювера. Чтобы это заработало, находясь на странице доски надо нажать `F12`
  ...
  - UX: айтемы-фреймы можно теперь можно перетаскивать за текстовой лейбл
  - теперь поддерживаются геймпады от Playstation 4 DualShock
      - геймпад уже раздроченный, поэтому пришлось компенсировать раздроченность с помощью `apply_dead_zone`
      - раздроченость заключается в том, что в состоянии покоя стики выдают сигналы будто они чуть отодвинуты в сторону
