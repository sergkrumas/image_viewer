...
- BOARDS
    ...
    - (6 мар 26) СЕНСАЦИЯ: прогрессивная развёртка айтемов-изображений на доске
        ...
        - ради этой фичи у айтемов появился атрубут visible, потому что код генерации превьюшек вклинивается и из-за этого айтемы мелькают в области ориджина перед тем как попасть на своё место
