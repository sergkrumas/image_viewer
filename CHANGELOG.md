...
- WATERFALL PAGE
    - (21 янв 26)-(29 янв 26) WATERFALL - новая страница в программе!
        - она будет совмещать столбцы больших превьюшек из правого столбца страницы Library и давать возможность модального просмотр каждой картинки при клике на превьюшке
            - однако, пока модальный просмотр не доступен и происходит перенаправление на страницу Viewer как в Library Page
