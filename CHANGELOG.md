  ...
  - (29 июн 25) портированный код примера Elastic Nodes из документации Qt превращён в плагин Elastiques Nodes для Boards
    ...
    - добавлен простенький редактор узлов и связей между ними
      ...
      - чтобы создать ребро надо нажать Е поочерёдно около каждого из двух двух узлов, которые нужно соединить
        - UX: первый выбранный узел автоматически исключается из набора узлов до выбоора второго узла, так что больше не получится добавить один и тот же узел два раза и получить сообщение об отмене
