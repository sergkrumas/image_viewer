  ...
  - (29 июн 25) портированный код примера Elastic Nodes из документации Qt превращён в плагин Elastiques Nodes для Boards
    ...
    - добавлен простенький редактор узлов и связей между ними
      ...
      - клавиши для переключения отображения векторов
        - `S` - сумма стягивающих векторов
        - `D` - сумма расталкивающих векторов
        - `F` - все стягиващие вектора
        - `G` - все расталкивающие вектора
        - `H` - сумма всех стягивающих и расталкивающих векторов
