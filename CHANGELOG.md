...
- Пофиксил баг: в изолированном режиме при закрытии окна не воспроизводилась анимация
...
- Восстановлена работа режима SlideShow
- При запуске расширенного режима иконка приложения в трее отображется сразу, а не после прогрузки библиотеки
