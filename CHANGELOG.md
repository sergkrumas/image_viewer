...
- BOARDS
  - доработка айтема-заметки (ITEM_NOTE)
    ...
    - UX tuning: в режиме редактирования клавиши стрелок `Вверх` и `Вниз` позволяют переместить курсор ввода в начало текста или в его конец, когда относительно курсора ввода нет строк сверху или снизу; с зажатым `Shift` это позволяет выделить первую или последнюю строку целиком 
