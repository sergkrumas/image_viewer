...
- Миниатюры в нижней части вьювера теперь проскальзывают при листании изображений как в Picasa Photo Viewer. Однако из-за долгой прогрузки самих картинок для подготовки к показу в главном потоке приложения, анимация иногда задерживается. Эта анимация вырубается через общую настройку для всех анимаций.
