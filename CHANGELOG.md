...
- доступен поиск потерянных картинок в специальной форме; форма отображается через клавишу Q
    ...
    - **для дальнейших доработок**
        ...
        - при определении потерянных записей надо оставлять ссылки на структуры данных, которые затем придётся править
        - поиск файла очень тупой, для каждой потерянной записи в каждой папке для поиска будет заново просчитываться размер и md5 
        - текстовой вывод странноватый и недоработанный
