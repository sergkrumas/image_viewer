...
- Теперь миниатюрки в нижней части вьювера создаются рядом с текущей на данный момент миниатюркой и, причём по очереди в обе стороны, что в результате даёт приятный анимационный эффект, который в Picasa Photo Viewer ещё украшен постепенным масштабированием каждой миниатюрки по диагоанили. Здесь от лишних украшений пришлось отказаться, потому что на Python летать это не будет, поэтому вышло сромней, но всё равно ещё одна частичка Picasa Photo Viewer передана. Раньше превьюшки создавались в порядке следования - строго от первой до последней, не учитывая положение текущей превьюшки.
