...
- (27 ноя 24) вернул отрисовку надписи ЗАГРУЗКА во вьювере при открытии приложения. Раньше между стартом приложения и показом картинки из папки отображалсь стартовая страница
Viewer
