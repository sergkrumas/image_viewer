...
- BOARDS
    ...
    - (4 мар 26) с геймпада теперь можно листать кадрых видимых в окне анимационные айтемов (а заодно айтемы папок и групп)
        ...
        - **можно синхронизировать прокрутку айтемов, которые видно, но оставлю это на будущее**
        - **вертикальную линию-оверлей как у Cursor Scrubber создавать не стал**
        - **ещё можно сделать, чтобы по нажатию на какую-нибудь из кнопок, открывался первый/последний кадр**
- VIEWER
