...
class Globals():
    ...
    ENABLE_PROGRESSIVE_BOARD_LAYOUT = True
...
class MainWindow(QMainWindow,
    ...
    def waterfall_page_previews_columns_content_height(self, folder_data):
        ...
        # WARNING: Если высота каждой превьюшки в столбце N небольшая, но этих превьюшек намного больше,
        # чем превьюшек в столбце N+1, в котором свою очередь превьюшки намного выше,
        # то может стать так, что максимальным столбцом по высоте станет N.
        # Поэтому, т.к. высота каждой превьюшки разнится,
    ...
    def draw_waterfall_content(self, painter, render_as_blackplate=False):
        ...
        self.draw_previews_grid(painter,
                                        ...
                                        progressive_ongoing=cf.waterfall_previews.progressive_ongoing
                                    )
    ...
    def draw_library(self, painter):
        ...
        self.draw_previews_grid(painter,
                                        ...
                                        corner_radius=self.STNG.library_corner_radius,
                                        progressive_ongoing=cf.library_previews.progressive_ongoing
                                    )
    ...
    def draw_viewer_content(self, painter):
        ...
        if self.movie:
            ...
            progress_bar_rect = QRectF(r.left(), r.bottom(), int(progress_width), 2)
